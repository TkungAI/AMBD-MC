# 重要提示：legacy目录下旧文件已弃用

**legacy/目录下所有文件为过时旧模型，不再维护。在未来将会被移除。**

## 特别声明

- **legacy/目录下所有文件不遵循MIT许可，所有权利归autoMBD作者<邮箱tkung.lqk@foxmail.com>所有**
- **该目录下文件不允许任何修改、合并、发布、分发、分许可和/或销售本软件副本，仅供学习使用**
- **legacy目录下文件与仓库MIT许可不冲突，仓库中其他文件遵循MIT许可**
